...
#ZSH_THEME="avit"
#ZSH_THEME="dan-intheloop"
ZSH_THEME="spaceship"

#Spaceship theme options
SPACESHIP_TIME_SHOW=true
SPACESHIP_TIME_FORMAT="%D{%Y-%m-%d %L:%M:%S}"
...
if [[ "$unamestr" == 'Darwin' ]]; then
  plugins=(alias-finder aws colored-man-pages cp docker git jsontools kubectl osx rsync tmux urltools vscode web-search zsh-syntax-highlighting)
else
